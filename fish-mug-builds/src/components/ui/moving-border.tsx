...
export function MovingBorderButton({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-full w-full items-center justify-center border border-border bg-background/80 text-base font-medium text-foreground antialiased backdrop-blur-xl",
          className
        )}
        style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}
      >
