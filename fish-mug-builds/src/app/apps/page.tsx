...
const allApps = [
  ...
  },
  {
    ...
    modalInfo: {
      fullDescription: "An intelligent AI-powered platform for tabletop RPGs. Manage campaigns, create heroes, organize parties, and generate avatars with the help of AI to enhance your role-playing game sessions.",
      features: [
        "AI-powered campaign management",
        "Character creation and hero management",
        "Party organization tools",
        "Avatar generation and customization",
        "Comprehensive documentation and guides",
        "Intelligent RPG assistance for dungeon masters",
      ],
      liveUrl: "https://digital-dungeonmaster.vercel.app/",
      githubUrl: "https://github.com/briansproule20/digital-dungeonmaster",
    },
  },
  {
    name: "Echo App Directory",
    icon: <img src="/app-icons/echo-directoryfavicon.png" alt="Echo App Directory" className="size-8" />,
    href: "https://echo-directory.vercel.app/",
    modalInfo: {
      fullDescription: "A centralized marketplace for discovering and exploring applications built on the Echo platform. Browse the comprehensive app library, use AI-powered chat to find the perfect tools, and identify opportunities in the Echo ecosystem.",
      features: [
        "AI-powered chat for app discovery",
        "Comprehensive Echo app library",
        "Detailed stats and information for each app",
        "Identify gaps and opportunities in the Echo platform",
        "Secure authentication with Echo integration",
        "Ecosystem insights for developers",
      ],
      liveUrl: "https://echo-directory.vercel.app/",
      githubUrl: "https://github.com/briansproule20/echo-directory",
    },
  },
  {
    name: "Echo Ideas",
    icon: <img src="/app-icons/echo-ideasfavicon.png" alt="Echo Ideas" className="size-8" />,
    href: "https://echo-ideas-nu.vercel.app/",
    modalInfo: {
      fullDescription: "An AI-powered app idea generator leveraging Echo's LLM infrastructure to create innovative application concepts. Generate unique ideas with custom prompting, save your favorites, and explore them further through smart chat interactions.",
      features: [
        "AI-powered app concept generation",
        "Advanced AI models with custom prompting",
        "Save and bookmark favorite ideas",
        "Smart chat interface for idea exploration",
        "Refine and develop concepts collaboratively",
        "Built on Echo's LLM infrastructure",
      ],
      liveUrl: "https://echo-ideas-nu.vercel.app/",
      githubUrl: "https://github.com/briansproule20/echo-ideas",
    },
  },
  {
    name: "Echo Studio",
  ...
  {
    name: "File Renamer",
    icon: <img src="/app-icons/file renamer favicon.png" alt="File Renamer" className="size-8" />,
    href: "https://echo-file-renamer.vercel.app/",
    modalInfo: {
      fullDescription: "An AI-powered application designed to streamline bulk file renaming operations. Leverage intelligent AI suggestions to rename multiple files efficiently with a clean, user-friendly interface and built-in Echo billing integration.",
      features: [
        "AI-powered intelligent file renaming",
        "Bulk rename operations for multiple files",
        "Secure authentication with Echo integration",
        "Built-in billing for usage management",
        "Clean, modern interface with theme toggle",
        "Fast and efficient batch processing",
      ],
      liveUrl: "https://echo-file-renamer.vercel.app/",
      githubUrl: "https://github.com/briansproule20/echo-file-renamer",
    },
  },
  {
    name: "Fuzzy Pancake",
  ...
  },
  {
    ...
    modalInfo: {
      fullDescription: "Get life advice from your favorite fictional characters and NPCs through AI-powered chat. Be warned: some of these individuals have not made good life choices. A humorous take on advice-giving powered by Echo.",
      features: [
        "Chat with fictional characters and NPCs",
        "AI-powered character personalities",
        "Life advice from unconventional sources",
        "Humorous and entertaining interactions",
        "Powered by Echo AI integration",
        "Wide variety of character advisors",
      ],
      liveUrl: "https://npc-chat-bay.vercel.app/",
      githubUrl: "https://github.com/briansproule20/npc-chat",
    },
  },
  {
  ...
  },
  {
    ...
    icon: <img src="/app-icons/AP favicon light.png" alt="Writing Portfolio" className="size-8" />,
    href: "https://www.alexanderpayiavlas.com/",
    modalInfo: {
      fullDescription: "Personal portfolio website for Alexander Payiavlas, writer and poet. A clean, minimal showcase featuring prose and verse with thoughtful design and modern web technologies.",
      features: [
        "Professional writing portfolio",
        "Poetry and prose showcase",
        "Clean, minimal design aesthetic",
        "Dark/light mode theme toggle",
        "Responsive layout for all devices",
        "Modern Next.js architecture",
      ],
      liveUrl: "https://www.alexanderpayiavlas.com/",
      githubUrl: "https://github.com/briansproule20/ap-portfolio",
    },
  },
  {
    name: "Yes Chef",
